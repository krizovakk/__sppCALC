...
# ------------------------------------- packages
# nacte potrebne baliky viz komentar
...
otc <- read_excel(paste0(path, "vstupy/input_cvicneOTC.xlsx"), sheet = 3) # sheet 2 pro Q1, sheet 3 pro Q2
